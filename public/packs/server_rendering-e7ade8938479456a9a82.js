  ...
  _createClass(EditableTitle, [{
    ...
    value: function render() {
      if (this.state.editing) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__TitleForm__["TitleForm"], { titleName: this.state.postTitle, slugName: this.state.postSlug, cancelEdit: this.cancelEdit, updatePost: this.updatePost, postID: this.state.postID });
      } else {
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-e7ade8938479456a9a82.js.map