...
var EditableTitle = function (_Component) {
  ...
  function EditableTitle(props) {
    ...
    //this.updateTitleAndSlug = this.updateTitleAndSlug.bind(this);
    return _this;
  }
  ...
  _createClass(EditableTitle, [{
    ...
    /*
    updateTitleAndSlug(newTitle, newSlug) {
      this.setState({
        blogPost: {
          title: newTitle,
          slug: newSlug
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-cc2f34ac29deb0d0d80a.js.map