    ...
    value: function handleSubmitClick() {
      ...
      if (newSlug !== '') {
        $.ajax({
          ...
          data: { _method: 'PUT', title: newTitle, slug: newSlug },
          dataType: 'json',
  ...
  _createClass(EditableTitle, [{
    ...
    value: function render() {
      if (this.state.editing) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__TitleForm__["TitleForm"], { titleName: this.props.titleName, slugName: this.props.slugName, cancelEdit: this.cancelEdit, postID: this.props.postID });
      } else {
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-2f1fa7f4d221551a4946.js.map