...
var TitleForm = function (_Component) {
  ...
  _createClass(TitleForm, [{
    ...
    value: function handleKeyUp(e) {
      ...
      if (newSlug === '') {
        document.getElementById("checkmarkID").classList.add("checkmark-icon-container--disabled");
        document.getElementById("liveSlug").innerHTML = "please enter a post title";
      } else {
        document.getElementById("checkmarkID").classList.remove("checkmark-icon-container--disabled");
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            { id: 'checkmarkID', className: 'checkmark-icon-container' },
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-59185c020c13f5a83255.js.map