  ...
  _createClass(EditableTitle, [{
    ...
    value: function render() {
      if (this.state.editing) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__TitleForm__["TitleForm"], { titleName: this.state.blogPost.title, slugName: this.state.blogPost.slug, cancelEdit: this.cancelEdit, updatePost: this.updatePost, postID: this.state.blogPost.id });
      } else {
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-2ef0db4018bba6984034.js.map