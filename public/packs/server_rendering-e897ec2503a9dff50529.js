...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected ; (50:11)\n\n  48 |   }\n  49 | \n> 50 |   render() {\n     |            ^\n  51 |     if (this.state.editing) {\n  52 |       return (\n  53 |         <TitleForm titleName={this.state.postTitle} slugName={this.state.postSlug} postID={this.state.postID} usedSlugs={this.state.usedSlugs} cancelEdit={this.cancelEdit} updatePost={this.updatePost} />\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-e897ec2503a9dff50529.js.map