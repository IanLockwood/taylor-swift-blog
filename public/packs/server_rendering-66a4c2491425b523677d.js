...
var TitleForm = function (_Component) {
  ...
  function TitleForm(props) {
    ...
    _this.handleUpdateTitleAndSlug = _this.handleUpdateTitleAndSlug.bind(_this);
    return _this;
  }
  ...
  _createClass(TitleForm, [{
    ...
    key: 'handleUpdateTitleAndSlug',
    value: function handleUpdateTitleAndSlug(newTitle, newSlug) {
      this.props.updateTitleAndSlug(newTitle, newSlug);
    }
  }, {
    ...
    value: function handleSubmitClick() {
      ...
      if (newSlug !== '') {
        $.ajax({
          type: "POST",
          url: '/blog_posts/' + this.props.postID,
          method: "PUT",
          data: { blog_post: { 'title': newTitle, 'slug': newSlug } },
          dataType: 'json'
        }).done(function () {
          this.handleUpdateTitleAndSlug(newTitle, newSlug);
          this.props.cancelEdit();
        });
      }
    }
...
var EditableTitle = function (_Component) {
  ...
  function EditableTitle(props) {
    ...
    _this.state = {
      editing: false,
      blogPost: _this.props.blogPost
    };

    _this.editTitle = _this.editTitle.bind(_this);
    _this.cancelEdit = _this.cancelEdit.bind(_this);
    _this.updateTitleAndSlug = _this.updateTitleAndSlug.bind(_this);
    return _this;
  }
  ...
  _createClass(EditableTitle, [{
    ...
    key: 'updateTitleAndSlug',
    value: function updateTitleAndSlug(newTitle, newSlug) {
      this.setState({
        blogPost: {
          title: newTitle,
          slug: newSlug
    ...
    value: function render() {
      if (this.state.editing) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__TitleForm__["TitleForm"], { titleName: this.state.blogPost.title, slugName: this.state.blogPost.slug, cancelEdit: this.cancelEdit, updateTitleAndSlug: this.updateTitleAndSlug, postID: this.state.blogPost.id });
      } else {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__StaticTitle__["StaticTitle"], { titleName: this.state.blogPost.title, editTitle: this.editTitle });
      }
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-66a4c2491425b523677d.js.map