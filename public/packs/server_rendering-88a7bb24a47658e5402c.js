...
throw new Error("Module build failed: Duplicate declaration \"title\"\n\n  17 | \n  18 |   getNewSlug(title) {\n> 19 |     let title = title;\n     |         ^\n  20 |     let newSlug = title.replace(/[^\\w\\s]/g,'');\n  21 |     newSlug = newSlug.replace(/\\s+/g, '-').toLowerCase();\n  22 |     return newSlug;\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-88a7bb24a47658e5402c.js.map