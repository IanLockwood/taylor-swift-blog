    ...
    value: function handleSubmitClick() {
      ...
      if (newSlug !== '') {
        $.ajax({
          ...
          console.log("this one" + newUsedSlugs);
          window.history.replaceState({ slug: newSlug }, newTitle, newSlug);
          scopeProps.updatePost(newTitle, newSlug, blog_post_slugs);
...
var EditableTitle = function (_Component) {
  ...
  _createClass(EditableTitle, [{
    ...
    key: 'updatePost',
    value: function updatePost(newTitle, newSlug, newUsedSlugs) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-abfda4705530f1122389.js.map