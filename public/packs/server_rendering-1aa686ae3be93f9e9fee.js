...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected ; (46:17)\n\n  44 |       this.setState(prevState => {\n  45 |         usedSlugs: prevState.usedSlugs.filter(i => i !== oldSlug),\n> 46 |         postTitle: newTitle,\n     |                  ^\n  47 |         postSlug: newSlug\n  48 |       });\n  49 |       console.log(this.state.usedSlugs);\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-1aa686ae3be93f9e9fee.js.map