...
var TitleForm = function (_Component) {
  ...
  _createClass(TitleForm, [{
    ...
    key: 'getNewpSlug',
    value: function getNewpSlug(title) {
      var newSlug = title.replace(/[^\w\s]/g, '');
      newSlug = newSlug.replace(/\s+/g, '-').toLowerCase();
      return newSlug;
    }
    ...
    value: function handleSubmitClick() {
      ...
      var newSlug = this.getNewpSlug(newTitle);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-472d64a963f63579f049.js.map