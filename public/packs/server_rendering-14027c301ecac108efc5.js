...
var TitleForm = function (_Component) {
  ...
  _createClass(TitleForm, [{
    ...
    value: function handleSubmitClick() {
      ...
      var interiorProps = this.props;

      if (newSlug !== '') {
        $.ajax({
          type: "POST",
          url: '/blog_posts/' + interiorProps.postID,
          method: "PUT",
          ...
          console.log(newSlug);
          console.log(this);
          interiorProps.updateTitleAndSlug(newTitle, newSlug);
          interiorProps.cancelEdit();
        });
      }
    }
  }, {
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-14027c301ecac108efc5.js.map