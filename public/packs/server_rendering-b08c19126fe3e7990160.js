...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected ; (51:11)\n\n  49 |   }\n  50 | \n> 51 |   render() {\n     |            ^\n  52 |     if (this.state.editing) {\n  53 |       return (\n  54 |         <TitleForm titleName={this.state.postTitle} slugName={this.state.postSlug} postID={this.state.postID} usedSlugs={this.state.usedSlugs} cancelEdit={this.cancelEdit} updatePost={this.updatePost} />\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-b08c19126fe3e7990160.js.map